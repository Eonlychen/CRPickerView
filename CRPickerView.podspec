#
# Be sure to run `pod lib lint CRPickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CRPickerView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CRPickerView.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'CRPickerView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CRPickerView' => ['CRPickerView/Assets/*.png']
  # }
